...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_3->setGeometry(QRect(290, 200, 85, 27));
        ...
        menuBar->setGeometry(QRect(0, 0, 681, 27));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setText(QApplication::translate("MainWindow", "Stop WEB Server", 0));
        pushButton->setText(QApplication::translate("MainWindow", "Start WEB Server", 0));
